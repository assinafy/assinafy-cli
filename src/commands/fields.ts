...
const createCommand = new Command('create')
	...
	.option('--inactive', 'Compatibility: create the field inactive')
...
const updateCommand = new Command('update')
	...
	.argument('<id>', 'Field ID')
	.option('--type <type>', 'Compatibility: change the field type')
	...
	.addOption(new Option('--required', 'Compatibility: mark as required').conflicts('optional'))
	.addOption(new Option('--optional', 'Compatibility: mark as not required').conflicts('required'))
